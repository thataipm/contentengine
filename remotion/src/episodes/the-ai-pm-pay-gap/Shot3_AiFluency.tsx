...
// up from twenty three percent just last year." (256 frames). Real
...
const StatCallout: React.FC<{ value: string; label: string; sublabel: string; born: number; frame: number; fps: number }> = ({
  ...
  return (
    <div style={{ textAlign: "center", opacity, transform: `scale(${scale})`, maxWidth: 800 }}>
      <div style={{ fontFamily: F_ACCENT, fontSize: 104, fontWeight: 800, color: ACCENTS[0], textShadow: `0 0 50px ${ACCENTS[0]}55` }}>{value}</div>
